...
I want to use something I am very familiar with, so this year I will use Python 3.14 for all the puzzles. This will make sure I can be the most efficient with my time. 

## Write Ups

I will be documenting my thought process while I code and sharing them here. Each day will have its own directory. The readme in each directory will be the write up for that day.
